...
class mag(object):
    ...
    def play_temporal(self, vid_dir, out_dir, alpha, freq, fs, filter_type, n_filter_tap):
        ...
        Args:
            ...
            filter_type: Type of filter to use. Can be one of "butter", or "differenceOfIIR". For "differenceOfIIR", fl and fh specifies rl and rh coefficients as in Wadhwa et al.
        """
